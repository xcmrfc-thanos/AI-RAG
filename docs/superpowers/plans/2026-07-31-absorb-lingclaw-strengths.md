...
| **M1** | P1 MCP Server 或 P2 `@workflow` 中价值更明确者 | ~~独立计划完成统一 Gate~~ **P2 已交付**（静态冒烟通过；UI Live Run 待服务） |
...
3. **当前阻塞：** P1 / P3 无已登记使用方 → **不自动开工**；服务就绪时可补 `.\verify-ai-workflow-trigger.ps1 -Live` 与 UI 开开关一次 Run。
