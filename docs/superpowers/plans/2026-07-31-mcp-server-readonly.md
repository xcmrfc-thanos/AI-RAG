...
- [x] ~~`check_sensitive` 只读工具~~ → **2026-07-31 产品决定不做**，不进入排期

> **说明（2026-07-31）：** Task 0–4 与统一交付 Gate 已完成；P1 专项关闭，无后续强制 Task。
...
| 2026-07-31 | 文档 Gate | 完成（README 索引 + mcp-server-ops） |
| 2026-07-31 | Task 5 | **取消**（不做 check_sensitive） |
