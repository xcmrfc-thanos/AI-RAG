...
public class ReviewNotificationListener {
    ...
    private List<Long> findReviewerUserIds() {
        try {
            // 1. 优先查询审核员
            Result<List<Long>> result = userAuthClient.getUserIdsByRole("ROLE_REVIEWER");
            ...
            Result<List<Long>> adminResult = userAuthClient.getUserIdsByRole("ROLE_ADMIN");
            ...
            Result<List<Long>> superAdminResult = userAuthClient.getUserIdsByRole("ROLE_SUPER_ADMIN");
