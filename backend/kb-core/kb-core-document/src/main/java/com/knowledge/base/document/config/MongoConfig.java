...
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    @Value("${spring.data.mongodb.authentication-database:knowledge_base}")
    ...
    public MongoClient mongoClient() {
        ...
        // 认证库需与 init-user.js 中 createUser 所在库一致（默认 knowledge_base）
        mongoUri.append("?authSource=").append(authenticationDatabase);
