...
| 原路径 | 新归属 |
|--------|--------|
| `/api/graph/**` | `kb-intelligence-app` → `kb-intelligence-graph` |
| Neo4j 图谱读写 | `kb-intelligence-graph`（进程内 GraphService） |
| Document REMOVED 消费 | 合并至 `kb-intelligence` |
